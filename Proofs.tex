...
\begin{proof}[Alternate proof of part (a)]
  ...
  \end{table}\marginnote[-.7in]{This kind of proof is fine for propositional logic, but the paragraph-style is preferred since ``proof by table'' isn't an option in the rest of this text.}  
\end{proof}
