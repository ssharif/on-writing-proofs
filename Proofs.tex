...
\end{definition}
One way to think of negation is that if a \knave says P, then a \knight would say $\neg$ P, and vice versa. Thus, the negation of ``The sky is blue'' is ``The sky is not blue''.
...
\begin{example}
  ...
  \end{enumerate}
  It turns out\sidenote{You should check this yourself!} that both statements are false in case 1, and true in every other case.
\end{example}
