...
\begin{enumerate}
  ...
  \end{enumerate}
    ...
    \item For $n \in \N$, let $A_n$ be the interval $(-\frac{1}{n}, \frac{1}{n})$. What are $\cup A_n$ and $\cap A_n$?\sidenote{The omission of the index means over all possible $n$. This is analogous to writing, for example, $\sum a_n$ instead of $\displaystyle\sum_{n=1}^{\infty} a_n$.}
